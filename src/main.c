...
int main(void)
{
  ...
  const struct device *const pr = DEVICE_DT_GET_ONE(seeed_grove_light);
  ...
  while (true)
  {
    ...
    sensor_channel_get(pr, SENSOR_CHAN_LIGHT, &lux);
